                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span
                                        class="badge bg-{{ $item->hasil_akhir == 'Layak' ? 'success' : 'danger' }}">
                                        {{ $item->hasil_akhir }}
                                    </span>
                                </td>
                                <td class="text-center">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('approval.approved', $item->id_hasil_perhitungan) }}" class="btn btn-success">Setujui</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="modalRejected{{ $item->id_hasil_perhitungan }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <a href="{{ route('approval.rejected', $item->id_hasil_perhitungan) }}" class="btn btn-danger">Tolak</a>
                    </div>
                </div>
            </div>
        </div>
